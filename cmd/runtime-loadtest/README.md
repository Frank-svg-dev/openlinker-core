...
```bash
go run ./cmd/runtime-loadtest +  -database-url "$DATABASE_URL" +  -db-activity-sample-interval 0 +  -db-strict-idle-commit-rate 2 +  -connection-capacity +  ...the remaining Runtime flags...
```
