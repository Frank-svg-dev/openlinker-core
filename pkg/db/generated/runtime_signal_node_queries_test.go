...
func TestHasActiveRuntimeV2SessionForAgentUsesDurableCurrentTruth(t *testing.T) {
	...
	for _, guard := range []string{
		...
		"s.heartbeat_at >= clock_timestamp() - INTERVAL '15 seconds'",
		"n.last_seen_at >= clock_timestamp() - INTERVAL '15 seconds'",
		"t.status = 'active_runtime'",
		"t.revoked_at IS NULL",
		"t.scopes @> ARRAY['agent:pull']::text[]",
		"t.expires_at > clock_timestamp()",
		"contract.is_current",
		"runtime_contract_digest = '60bef5cec7eeab563937187f48a458059995aebee161765032cddc17d0cdfa61'",
		"'persistent_spool'",
