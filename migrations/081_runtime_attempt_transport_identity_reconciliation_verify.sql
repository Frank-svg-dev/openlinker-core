...
BEGIN
    IF (
        ...
        RAISE EXCEPTION 'migration 081 canonical Runtime schema contract 80 is missing or mismatched';
    END IF;
    IF (
        SELECT COUNT(*) FROM runtime_schema_contracts
        ...
        RAISE EXCEPTION 'migration 081 historical Runtime schema contract 77 is missing or mismatched';
    END IF;
    IF EXISTS (
        ...
        RAISE EXCEPTION 'migration 081 intermediate Runtime schema contract 79 history is invalid';
    END IF;
    IF NOT EXISTS (
